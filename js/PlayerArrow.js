class PlayerArrow {
  ...
  display() {
    ...
    /*if (this.body.velocity.x > 0 || this.body.position.x > 400) {
      var position = [this.body.position.x, this.body.position.y];
      trajectory.push(position);XXXXXXXXXXXXX
    }*/

    /*if (this.body.velocity.x < 0 && this.body.position.x < 400) {
      var position = [this.body.position.x, this.body.position.y];
      this.trajectory(position);XXXXXXXXXXXX
    }*/

    /*if (this.body.velocity.x > 0 this.body.position.x > 400) {
      var position = [this.body.position.x, this.body.position.y];
      this.trajectory.push();XXXXXXXXXXXXX
    }*/

    for (var i = 0; i < this.trajectory.length; i++) {
      fill("white");

      //ellipse(this.trajectory[0], this.trajectory[1], 5, 5);XXXXXXXXXXXX  
      //ellipse(trajectory[i][0], trajectory[i][1], 5, 5);XXXXXXXXX
      ellipse(this.trajectory[i][0], this.trajectory[i][1], 5, 5);
      //ellipse(this.trajectory(i)(0), this.trajectory(i)(1), 5, 5);XXXXXXXXXXXX
